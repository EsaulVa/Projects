...
# ----------------------------------------------------------------------
R = 2.0                # радиус цилиндра и сфер
L = 6.0                # длина цилиндрической части
z_cyl_min = -L/2
z_cyl_max =  L/2
...
tan_theta = 0.1       # для геодезической (можно 0.1 для винтового эффекта)
...
v_start = balloon.v_min +0.2  # отступим от самого низа, чтобы избежать полюса
u0 = 0
v0 = v_start
