...
"""
Клиент коллокации для баллона.
Ключевое исправление: поиск начальной точки перебором v.
"""
import numpy as np
...
if best_Phi < 1e-3:
    ...
    print(f"WARNING: newton_corrector не сошёлся, используем safe_initial_point")
