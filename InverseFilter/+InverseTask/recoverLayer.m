...
%   z_hist - массив узлов, в которых вычислено решение
    ...
    for i = 1:Nsteps
        ...
        r = surf.getPoint(u, v); r=r(:);
        tau = (R - r) / norm(R - r); 
        [du_s, dv_s] = InverseTask.computeTangentCoeffs(surf, u, v, tau);
        dsdz = InverseTask.compute_dsdz(surf, u, v, du_s, dv_s, R, Rprime, DeltaZ, Percentage);
        dudz = du_s * dsdz;
        dvdz = dv_s * dsdz;
        ...
        [du_s_mid, dv_s_mid] = InverseTask.computeTangentCoeffs(surf, u_mid, v_mid, tau_mid);
        dsdz_mid = InverseTask.compute_dsdz(surf, u_mid, v_mid, du_s_mid, dv_s_mid, R_mid, Rprime_mid, DeltaZ, Percentage);
        ...
        [du_s_next, dv_s_next] = InverseTask.computeTangentCoeffs(surf, u_next, v_next, tau_next);
        dsdz_next = InverseTask.compute_dsdz(surf, u_next, v_next, du_s_next, dv_s_next, R_next, Rprime_next, DeltaZ, Percentage);
